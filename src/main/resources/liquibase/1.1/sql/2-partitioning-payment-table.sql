...
begin
    ...
    alter table payment_api_app.payment validate constraint payment_old_records;
    commit;

    alter table payment_api_app.payment rename to payment_old;
    ...
    create table if not exists payment_api_app.payment_20240501(like payment_api_app.payment including all);
    ...
    alter table payment_api_app.payment_old drop constraint payment_old_records;
    commit;
end
$BODY$;
