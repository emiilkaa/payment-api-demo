...
begin
    ...
    alter table payment_api_app.card_data validate constraint card_data_old_records;
    commit;

    alter table payment_api_app.card_data rename to card_data_old;
    ...
    create table if not exists payment_api_app.card_data_20240501(like payment_api_app.card_data including all);
    ...
    alter table payment_api_app.card_data_old drop constraint card_data_old_records;
    commit;
end
$BODY$;
